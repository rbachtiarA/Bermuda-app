...
export default function NavbarMobileHamburger(
    {dropdownSearch, setDropdownSearch,dropdownHamburger,setDropdownHamburger, onLogout,token,isLoading,searchData}:
    {
        dropdownSearch: boolean, setDropdownSearch: Dispatch<SetStateAction<boolean>>,
        dropdownHamburger: boolean, setDropdownHamburger: Dispatch<SetStateAction<boolean>>,
        onLogout: () => void, token: string|null, isLoading: boolean, searchData: IProduct[]
    }) {
