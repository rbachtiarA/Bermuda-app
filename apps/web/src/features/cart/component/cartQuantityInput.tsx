...
export default function CartQuantityInput({
  ...
  const productStock =
    cart.product?.stock![0] === undefined
      ? 0
      : cart.product?.stock![0].quantity!;
  ...
  function ButtonControl({
    ...
    return (
      <Button
        ...
        isDisabled={
          isDisabled || isLoading === 'CHECKOUT' || productStock === 0
        }
        isIconOnly
    ...
    <div className="flex flex-col md:flex-row justify-center items-center">
      <div className="flex w-full justify-end">
        <p className="text-[10px]">
          <span>Sisa item: </span> {productStock}
        </p>
      </div>
      <div className="flex gap-1 w-full justify-end">
        ...
        <Input
          ...
          onChange={(e) => onChangeQuantityInput(e)}
          isDisabled={productStock === 0 || isLoading === 'CHECKOUT'}
        ...
        />
        <ButtonControl
          isDisabled={quantity >= productStock}
          quantityControl={1}
        >
          <PlusIcon />
        </ButtonControl>
