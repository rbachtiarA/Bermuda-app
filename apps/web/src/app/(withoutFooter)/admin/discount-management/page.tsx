...
//         {/* Create Manual Discount Section */}
//         <div className="bg-white shadow-lg rounded-lg p-6 transition-transform hover:scale-105 duration-300">
...
//         {/* Create Discount by Minimum Purchase Section */}
//         <div className="bg-white shadow-lg rounded-lg p-6 transition-transform hover:scale-105 duration-300">
//           <h2 className="text-xl font-semibold text-gray-700 mb-4 text-center">
...
//         {/* Create Buy One Get One Discount Section */}
//         <div className="bg-white shadow-lg rounded-lg p-6 transition-transform hover:scale-105 duration-300">
//           <h2 className="text-xl font-semibold text-gray-700 mb-4 text-center">
  ...
  return (
    <div className="bg-gray-50 min-h-screen p-6 md:p-10 transition-all duration-300">
      ...
      <Modal
        ...
        title="Create Buy One Get One Discount"
      >
        <CreateBuyOneGetOneDiscount />
      </Modal>
    </div>
